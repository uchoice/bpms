...
var ProcessDiagramGenerator = {	
	...
	showActivityInfo: function(activity){
		...
		var values = {
			...
			assignExp: activity.getProperty("assignExp"),
			candidateUserExp: activity.getProperty("candidateUserExp"),
		...
		if(activity.getProperty("type") == 'userTask'){
			...
			+ '<div><b>候选用户</b>: {candidateUserExp}</div>'
			+ '<div><b>候选组</b>: {candidateGroupExp}</div>';
			if(activity.getProperty("startTime")){
				TPL_ACTIVITY_INFO = TPL_ACTIVITY_INFO
